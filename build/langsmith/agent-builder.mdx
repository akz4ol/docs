...
<CardGroup cols={2}>
  <Card title="Create with a template" icon="shapes" href="/langsmith/agent-builder-quickstart">
...
<Note>
**Self-hosting for Agent Builder is available in Beta.** To enable it, upgrade to the [latest LangSmith version](/langsmith/self-hosted-changelog) and enable Agent Builder in `values.yaml`.
</Note>
